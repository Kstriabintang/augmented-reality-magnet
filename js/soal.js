...
export const QUESTIONS = [
  ...
  { t:"Sifat kemagnetan hilang", q:"Sebuah magnet digunakan terus-menerus dan sering terkena benturan keras sehingga tidak dapat menarik benda. Sifat kemagnetan suatu benda dapat hilang jika benda tersebut…", opts:["Direndam air","Dipukul-pukul","Dilapisi kain","Didinginkan"], correct:1, pembahasan:"Benturan keras dapat mengacak susunan partikel (magnet elementer) sehingga sifat kemagnetannya berkurang atau hilang." },
  ...
  { t:"Sifat magnet", q:"Seorang siswa mengambil benda dari kotak berisi campuran pasir, paku, dan potongan plastik. Ia mengatakan semua benda dalam kotak dapat ditarik magnet. Tanggapan yang tepat adalah…", opts:["Benar, karena magnet dapat menarik semua benda","Benar, karena pasir bersifat magnetis","Salah, karena magnet hanya dapat menarik benda tertentu seperti paku","Salah, karena magnet hanya menarik benda cair"], correct:2, pembahasan:"Magnet hanya menarik benda magnetis seperti besi, baja, nikel, dan kobalt — bukan semua benda." },
